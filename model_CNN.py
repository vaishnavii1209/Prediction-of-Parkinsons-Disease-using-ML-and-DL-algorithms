...
path1 = 'D:/Ravina data/parkisons disease/Project Dataset/archive (10)/3_cls/training/1'    #path of folder of images    
path2 = 'D:/Ravina data/parkisons disease/Project Dataset/archive (10)/3_cls/testing/1'  #path of folder to save images    
